...
Aplicación web de 3 capas que permite a los usuarios registrarse, publicar posts, comentar y dar likes en un feed social.

## Integrantes y Roles

| Nombre | Rol | Tecnología |
|--------|-----|------------|
| (Frontend Developer) | Interfaz de usuario, componentes, navegación | React + Vite |
| Manuel Henao | Backend Developer | Node.js / Express |
| (Database Administrator) | Base de datos, schema, seed | MySQL |
